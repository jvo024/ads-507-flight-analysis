...
def operator_risk_call(api_key, file_name):
    ...
    print('Start API call (Operator Risk)')
    ...
    if response.status_code == 200:
        ...
        print('End API call (Operator Risk)')
...
def accidents_call(api_key, file_name):
    ...
    print('Start API call (Accidents)')
    ...
    if response.status_code == 200:
        ...
        print('End API call (Accidents)')

    else:
        print(f"Error: Unable to fetch data. Status code: {response.status_code}")

def incidents_call(api_key, file_name):

    print('Start API call (Incidents)')
    
    url = f"https://applications.icao.int/dataservices/api/incident?api_key={api_key}&StateOfOccurrence=&format=json&StateOfOperator=USA&StateOfRegistry=&Year="
